  ...
  experience: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Developed automated test scripts in C and Bash for motor quality control.",
        "Automation of quality control for electric motors in C and Bash via serial interface.",
      ],
    },
    {
  ...
  education: [
    {
      ...
      achievements: [
        "Master Thesis: Optimizing Predictive Maintenance with Automated Data Selection (Industry Collaboration).",
      ],
    },
    {
      school:
      ...
      achievements: [
        "Bachelor Thesis: Trolbot – RFID-based automation in retail.",
        "Quarterfinalist in DST & Texas Instruments India Innovation Challenge 2018–2019.",
      ],
    },
  ],
};
